...
(defface powerline-active1 '((t (:background "#2a7785" :foreground "white" :inherit mode-line)))
  "Powerline face 1."
  :group 'powerline)

(defface powerline-active2 '((t (:background "#3b5b63" :foreground "white" :inherit mode-line)))
  "Powerline face 2."
  :group 'powerline)
